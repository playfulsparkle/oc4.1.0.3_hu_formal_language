<?php
// Heading
$_['heading_title']                = 'Vásárlói tevékenység jelentés';

// Text
$_['text_extension']               = 'Bővítmények';
$_['text_edit']                    = 'Vásárlói tevékenység jelentés szerkesztése';
$_['text_success']                 = 'Siker: A vásárlói tevékenység jelentés sikeresen módosítva lett!';
$_['text_filter']                  = 'Szűrő';
...
$_['text_activity_reset']          = '<a href="customer_id=%d">%s</a> jelszó-visszaállítást kezdeményezett.';
$_['text_activity_login']          = '<a href="customer_id=%d">%s</a> bejelentkezett.';
$_['text_activity_forgotten']      = '<a href="customer_id=%d">%s</a> új jelszót igényelt.';
...
$_['text_activity_return_account'] = '<a href="customer_id=%d">%s</a> reklamációt nyújtott be.';
$_['text_activity_return_guest']   = '%s reklamációt nyújtott be.';
...
$_['text_activity_affiliate_edit'] = '<a href="customer_id=%d">%s</a> frissítette partner fiók adatait.';
$_['text_activity_transaction']    = '<a href="customer_id=%d">%s</a> jutalékot kapott egy új <a href="order_id=%d">rendelés után</a>.';
...
// Error
$_['error_permission']             = 'Figyelmeztetés: Nincs jogosultsága a vásárlói tevékenység jelentés módosításához!';
